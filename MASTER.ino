...
void loop()
{
    ...
    while(1)
    {
        ...
        if (pY > 100 || pY < -100 || pX > 100 || pX < -100){
          driveLeft += pX;
          driveRight += pX;
        ...
        if (driveLeft < 1400 && driveRight > 1600){
          Serial.println("Moving Forward");
          blueToothSerial.print("f");
          delay(200);
        } else if (driveLeft > 1600 && driveRight < 1400){
          Serial.println("Moving Backward");
          blueToothSerial.print("b");
          delay(200);
        } else if (driveLeft < 1400 && driveRight < 1400){
          Serial.println("Moving Left");
          blueToothSerial.print("l");
          delay(200);
        } else if (driveLeft > 1600 && driveRight > 1600){
